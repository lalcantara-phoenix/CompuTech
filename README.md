...
Web API REST desarrollada en .NET 10 para gestionar órdenes de servicio técnico de una empresa de venta y mantenimiento de computadoras y laptops.

## Stack

- **Backend:** ASP.NET Core 10 — Clean Architecture + CQRS (MediatR 14)
- **Validación:** FluentValidation 12
- **Base de datos:** SQL Server LocalDB — EF Core 10
- **Documentación:** Swagger / OpenAPI (Swashbuckle 10)
- **Tests:** xUnit 2.9 + Moq 4.20 + FluentAssertions 8.10
